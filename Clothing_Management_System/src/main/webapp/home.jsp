                ...
                <div class="text-white">
                    ...
                    <div class="flex justify-center">
                        <div class="">
                            ...
                            <p class="font-bold text-base  text-gray-400 pt-2 text-center w-24"><%=session.getAttribute("name") %></p>
                        </div>
                    </div>
                    <div>
                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="ml-2 w-full flex-1">
                                                <div>
                                                    ...
                                                    <div class="mt-1 text-base text-gray-600">Add Category</div>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                    <a class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                                        href="DeleteCategory.jsp">
                                        <div class="p-5">
                                            <div class="flex justify-between">
                                            ...
                                            <div class="ml-2 w-full flex-1">
                                                <div>
                                                    ...
                                                    <div class="mt-1 text-base text-gray-600">Delete Category</div>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="ml-2 w-full flex-1">
                                                <div>
													 ...
													 <div class="mt-3 text-3xl font-bold leading-8"><span>&#8377;</span> <%=session.getAttribute("earnings") %></div>
                                                    <div class="mt-1 text-base text-gray-600">Earnings</div>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
