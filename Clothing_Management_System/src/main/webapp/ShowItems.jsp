...
<div class="text-gray-900 bg-gray-800">
	...
	<%if(session.getAttribute("user").toString().equals("Agent"))
			{ session.setAttribute("CategoryName", request.getParameter("category")); %>
	<button class="block uppercase mx-auto shadow bg-indigo-800 hover:bg-indigo-700 focus:shadow-outline focus:outline-none text-white text-xs py-3 px-10 rounded" ><a href="addItems.jsp">ADD more</a></button>
